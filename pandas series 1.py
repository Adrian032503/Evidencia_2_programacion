...
notas_asignadas = pd.Series([87, 100, 85, 60, 78], index=["Crescencio", "Domitila", "Rutilio", "Pánfilo", "Ludoviko"])
print(notas_asignadas)
print(SEPARADOR)
print("Serie generada a partir de un diccionario")notas_asignadas_dict = pd.Series({"Crescencio":87, "Domitila":100, "Rutilio":85, "Pánfilo":60, "Ludoviko":78})
